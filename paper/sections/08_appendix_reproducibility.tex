...
\textbf{Experimental results:} Raw results and trained checkpoints archived at \url{https://anonymous.4open.science/r/bitnet}.

\subsection{Code Availability}

Complete source code, experiment commands, and documentation available at:
\begin{center}
\url{https://anonymous.4open.science/r/bitnet}
\end{center}
