...
All code, experiment logs, analysis scripts, and trained models are publicly available at \url{https://anonymous.4open.science/r/bitnet-0ABF} under MIT license. Running \texttt{make paper} regenerates all results and compiles this document from raw experiment data, enabling complete verification of our claims.
